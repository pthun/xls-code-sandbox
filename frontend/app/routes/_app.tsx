...
export default function AppLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      <aside className="flex w-56 shrink-0 flex-col border-r border-border bg-card px-4 py-8">
      ...
      <main className="flex flex-1 flex-col">
        <section className="flex-1 overflow-y-auto bg-muted/30 px-6 py-6">
          <div className="mx-auto w-full max-w-[calc(100vw-14rem)]">
            <Outlet />
          </div>
        </section>
      </main>
