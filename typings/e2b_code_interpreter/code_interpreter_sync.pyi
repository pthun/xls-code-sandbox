...
class Sandbox(BaseSandbox):
    ...
    default_template = ...
    @overload
    def run_code(self, code: str, language: Union[Literal["python"], None] = ..., on_stdout: Optional[OutputHandler[OutputMessage]] = ..., on_stderr: Optional[OutputHandler[OutputMessage]] = ..., on_result: Optional[OutputHandler[Result]] = ..., on_error: Optional[OutputHandler[ExecutionError]] = ..., envs: Optional[Dict[str, str]] = ..., timeout: Optional[float] = ..., request_timeout: Optional[float] = ...) -> Execution:
        """
    ...
    @overload
    def run_code(self, code: str, language: Optional[str] = ..., on_stdout: Optional[OutputHandler[OutputMessage]] = ..., on_stderr: Optional[OutputHandler[OutputMessage]] = ..., on_result: Optional[OutputHandler[Result]] = ..., on_error: Optional[OutputHandler[ExecutionError]] = ..., envs: Optional[Dict[str, str]] = ..., timeout: Optional[float] = ..., request_timeout: Optional[float] = ...) -> Execution:
        """
    ...
    @overload
    def run_code(self, code: str, context: Optional[Context] = ..., on_stdout: Optional[OutputHandler[OutputMessage]] = ..., on_stderr: Optional[OutputHandler[OutputMessage]] = ..., on_result: Optional[OutputHandler[Result]] = ..., on_error: Optional[OutputHandler[ExecutionError]] = ..., envs: Optional[Dict[str, str]] = ..., timeout: Optional[float] = ..., request_timeout: Optional[float] = ...) -> Execution:
        """
    ...
    def run_code(self, code: str, language: Optional[str] = ..., context: Optional[Context] = ..., on_stdout: Optional[OutputHandler[OutputMessage]] = ..., on_stderr: Optional[OutputHandler[OutputMessage]] = ..., on_result: Optional[OutputHandler[Result]] = ..., on_error: Optional[OutputHandler[ExecutionError]] = ..., envs: Optional[Dict[str, str]] = ..., timeout: Optional[float] = ..., request_timeout: Optional[float] = ...) -> Execution:
        ...
    
    def create_code_context(self, cwd: Optional[str] = ..., language: Optional[str] = ..., request_timeout: Optional[float] = ...) -> Context:
        """
