...
class Filesystem:
    ...
    """
    def __init__(self, envd_api_url: str, envd_version: Optional[str], connection_config: ConnectionConfig, pool: httpcore.AsyncConnectionPool, envd_api: httpx.AsyncClient) -> None:
        ...
    
    @overload
    async def read(self, path: str, format: Literal["text"] = ..., user: Username = ..., request_timeout: Optional[float] = ...) -> str:
        """
    ...
    @overload
    async def read(self, path: str, format: Literal["bytes"], user: Username = ..., request_timeout: Optional[float] = ...) -> bytearray:
        """
    ...
    @overload
    async def read(self, path: str, format: Literal["stream"], user: Username = ..., request_timeout: Optional[float] = ...) -> AsyncIterator[bytes]:
        """
    ...
    async def read(self, path: str, format: Literal["text", "bytes", "stream"] = ..., user: Username = ..., request_timeout: Optional[float] = ...): # -> str | bytearray | AsyncIterator[bytes]:
        ...
    
    async def write(self, path: str, data: Union[str, bytes, IO], user: Username = ..., request_timeout: Optional[float] = ...) -> WriteInfo:
        """
    ...
    async def write_files(self, files: List[WriteEntry], user: Username = ..., request_timeout: Optional[float] = ...) -> List[WriteInfo]:
        """
    ...
    async def list(self, path: str, depth: Optional[int] = ..., user: Username = ..., request_timeout: Optional[float] = ...) -> List[EntryInfo]:
        """
    ...
    async def exists(self, path: str, user: Username = ..., request_timeout: Optional[float] = ...) -> bool:
        """
    ...
    async def get_info(self, path: str, user: Username = ..., request_timeout: Optional[float] = ...) -> EntryInfo:
        """
    ...
    async def remove(self, path: str, user: Username = ..., request_timeout: Optional[float] = ...) -> None:
        """
    ...
    async def rename(self, old_path: str, new_path: str, user: Username = ..., request_timeout: Optional[float] = ...) -> EntryInfo:
        """
    ...
    async def make_dir(self, path: str, user: Username = ..., request_timeout: Optional[float] = ...) -> bool:
        """
    ...
    async def watch_dir(self, path: str, on_event: OutputHandler[FilesystemEvent], on_exit: Optional[OutputHandler[Exception]] = ..., user: Username = ..., request_timeout: Optional[float] = ..., timeout: Optional[float] = ..., recursive: bool = ...) -> AsyncWatchHandle:
        """
